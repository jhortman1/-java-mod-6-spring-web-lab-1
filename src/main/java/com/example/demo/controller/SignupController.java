...
public class SignupController {
    ...
    public ResponseEntity<SignupDTO> readSignup(@PathVariable(value = "signupId")Long id){
    ...
    public ResponseEntity<SignupDTO> updateSignup (@PathVariable(value = "signupId")Long id,@RequestBody SignupDTO signupDTO)
    {
    ...
    public void deleteSignup(@PathVariable(name = "id") Long id)
    {
